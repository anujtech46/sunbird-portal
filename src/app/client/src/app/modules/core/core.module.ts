...
import {
  ...
  CopyContentService, BreadcrumbsService, OrgDetailsService, JuliaBoxService
} from './services';
import {
  ...
  static forRoot(): ModuleWithProviders {
    return {
      ...
      providers: [LearnerService, UserService, TenantService, SearchService, CopyContentService,
        ...
        ConceptPickerService, BreadcrumbsService, PlayerService, OrgDetailsService, JuliaBoxService]
    };
  }
}
