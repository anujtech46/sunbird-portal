...
import { PublicPlayerService, LandingpageGuard, RssfeedService } from './services';
...
@NgModule({
  ...
  providers: [PublicPlayerService, DeviceDetectorService, LandingpageGuard, RssfeedService]
})
